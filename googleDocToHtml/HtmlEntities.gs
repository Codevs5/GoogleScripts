function test_entities_to_html(){
  var string = '£1,000 © hey ho'
  Logger.log( entities_to_html(string) )



}

function entities_to_html(string) {
  var p1 = ''
  var p2 = ''
  for (var i in entity_table) {
          string = string.replace(new RegExp(String.fromCharCode(i), "g"), entity_table[i]);
  }
  return string;
}
...
var entity_table = {
  ...
  //38: "&amp;",        //  Don't bother, to much DANGER!
  //60: "&lt;",     // Less-than sign
